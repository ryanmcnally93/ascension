...
class CategoryTestCase(TestCase):
    ...
    def setUp(self):
        Category.objects.create(
            name="electric_guitars", friendly_name="Electric Guitars"
        )
        Category.objects.create(name="drum_kits", friendly_name="Drum Kits")

    # This test is checking the friendly names of each, making sure they match
    ...
    # This test is checking the names of each, making sure they match
    def test_category_name(self):
        electric_guitars = Category.objects.get(
            friendly_name="Electric Guitars"
        )
...
class ProductTestCase(TestCase):
    ...
    # This test is checking the sku of each, making sure they match
    ...
    # This test is checking the description of each, making sure they match
    def test_product_description(self):
        guitar_strings_item = Product.objects.get(name="Test Guitar Strings")
        capo_item = Product.objects.get(name="Test Capo")
        session_item = Product.objects.get(name="Test Session")
        self.assertEqual(
            guitar_strings_item.description,
            "These guitar strings are a test item!",
        )
        self.assertEqual(capo_item.description, "This Capo is a test item!")
        self.assertEqual(
            session_item.description, "This Session is a test item!"
        )

    # This test is checking the price of each, making sure they match
    ...
    # This test is checking the amount sold of each, making sure they match
    ...
    # This test is checking the reviews for each, making sure they match
    ...
    # This test is checking the rating of each, making sure they match
    ...
    # This test is checking the main image of each, making sure they match
    ...
    # This test is checking the first image of each, making sure they match
    ...
    # This test is checking the second image of each, making sure they match
    ...
    # This test is checking the third image of each, making sure they match
