...
class OrderTestCase(TestCase):
    ...
    # This test is checking the order number of each, making sure they match
    ...
    # This test is checking the full names of each, making sure they match
    ...
    # This test is checking the email address of each, making sure they match
    ...
    # This test is checking the phone numbers of each, making sure they match
    ...
    # This test is checking the first line of the street address
    ...
    # This test is checking the second line of the street address
    ...
    # This test is checking the town/city of each, making sure they match
    ...
    # This test is checking the postcode of each, making sure they match
    ...
    # This test is checking the total cost of each, making sure they match
    ...
    # This test is checking the original cart of each, making sure they match
    ...
    # This test is checking the stripe PID of each, making sure they match
